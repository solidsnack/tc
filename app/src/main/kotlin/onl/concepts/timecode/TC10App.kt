...
import onl.concepts.timecode.timecodes.TC10

@Command(
    description = ["Subcommands for TC10 timecodes. With no subcommand, " +
                   "generates a new TC10 timecode, with the same options " +
                   "and behavior as the `encode` subcommand."],
    mixinStandardHelpOptions = true,
    name = "tc10",
    usageHelpAutoWidth = true,
)
class TC10App : Callable<Int> {
    @Spec
    ...
    fun decode(
        ...
        val parsed = TC10.of(timecode).getOrThrow()
